...
shared_data.frac_start_end={[0.1 0.5], [0.9 0.5]};
...
save(['u' num2str(hydro_problem.cislo_ulohy) '_onef.mat'],'SMALSE_params','hydro_problem','elast_problem','-v7.3')

params=-3;
tic;
[Q,D,PRESSURE,ugrad,iter,x_elast,response_D,hydro_change] = coup.coupled_solver_adaptive(hydro_problem,elast_problem,SMALSE_params,params);
toc
figure
plot(hydro_change)
