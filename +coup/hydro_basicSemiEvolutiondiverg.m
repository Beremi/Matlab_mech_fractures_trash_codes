function [PRESSURE,u0,GRAD,PRESSURE_diff,frac_grad,Q] = ...
    hydro_basicSemiEvolutiondiverg(D,hydro_problem,u0_old,mat_frac,divergence_diff)
...
[b_diver] = divergence_to_rhs( hydro_problem, divergence_diff );
b=hydro_problem.b+b_diver;
u0=hydro_problem.u0;
