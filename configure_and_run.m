...
%% ELAST PARAMETERS
elast_problem.sumbdomains_FETI=200;
...
save(['u' num2str(hydro_problem.cislo_ulohy) '_data.mat'],'SMALSE_params','hydro_problem','elast_problem','-v7.3')
